...
class RateQuotes extends AbstractRequest
{
    ...
    protected array $requested_package_line_items;
    ...
    /**
     * @param  mixed  $requested_package_line_items
     * @return $this
     */
    public function setRequestedPackageLineItems(array $requested_package_line_items): RateQuotes
    {
        $this->requested_package_line_items = $requested_package_line_items;
        return $this;
    }
    ...
    public function prepare(): array
    {
        ...
        if (!empty($this->shipper)) {
            $data['requestedShipment']['shipper']['address'] = $this->shipper->prepare();
        }
